...
@section('bc')
Input Data Rawat Kunjungan
@endsection

@section('content')

@if($patientRawatKunjunganTotal > 0)
<div class="col-md-6">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('rawat-kunjungan.addItem') }}" method="post" enctype="multipart/form-data">
                @csrf
            ...
            <div>
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            <td>Kode</td>
                            <td>: {{ sprintf('PASKAL%04d', $patientRawatKunjunganCart->id) }}</td>
                        </tr>
                        <tr>
                            <td>Nama</td>
                            <td>: <strong>{{ $patientRawatKunjunganCart->name }}</strong></td>
                        </tr>
                        <tr>
                            <td>Keluhan</td>
                            <td>: {{ $patientRawatKunjunganCart->options->simptom }}</td>
                        </tr>
                        <tr>
                            <td></td>
                            <td></td>
                ...
                <form action="{{ route('rawat-kunjungan.store') }}" method="post">
                    <div class="form-group">
                    ...
                    @if(Cart::instance('rawatKunjunganCart')->total()>0)
                    <input type="hidden" name="patientId" value="{{ $patientRawatKunjunganCart->id }}">
            ...
            <div class="card-tools">
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            @forelse ($rawatKunjunganCart as $item)
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>Grand Total</td>
                                <td class="text-right">
                                <strong>Rp.{{number_format($totalrawatKunjunganCart,2, ',', '.')}}</strong></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
